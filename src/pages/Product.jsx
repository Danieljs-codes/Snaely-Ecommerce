...
function Product() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 gap-y-8 py-[3.25rem] lg:grid-cols-2 lg:gap-x-8 xl:gap-x-11">
        <div>
          <img
        ...
        <div>
          ...
          <div>
            <RadioGroup className="mb-8" value={color} onChange={setColor}>
          ...
          <div className="flex flex-col gap-4 lg:flex-row">
            <motion.button
              ...
              initial={false}
              className="mt-0 flex w-full items-center justify-center rounded-full border border-primary-black-500 bg-transparent px-10 py-3 text-sm text-primary-black-500 lg:w-auto lg:py-4"
            >
              {addingToCart ? (
            ...
            <button
              ...
              className="rounded-full bg-primary-black-500 px-16 py-3 text-sm text-grey-50 disabled:cursor-not-allowed lg:py-4"
            >
              Buy Now
            </button>
          </div>
      ...
      <div className="grid lg:grid-cols-2">
        <div>
          <h3 className="mb-6 font-neue text-[1.75rem] text-primary-black-500">
            Description
          </h3>
          <Accordion
